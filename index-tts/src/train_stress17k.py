...
from indextts_lightning_precomputed_clean import IndexTTSLightningModulePrecomputed
from stress17k_precomputed_dataset import create_stress17k_precomputed_dataloader
...
def train(config_path: str):
    ...
    train_loader = create_stress17k_precomputed_dataloader(
        features_root=cfg.data.features_root,
    ...
    val_loader = create_stress17k_precomputed_dataloader(
        features_root=cfg.data.features_root,
        metadata_path=cfg.data.metadata_path,
